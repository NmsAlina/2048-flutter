...
import 'package:twenty_forty_eight/components/animation.dart';
...
class TileBoardWidget extends ConsumerWidget {
  const TileBoardWidget(
      {super.key, required this.moveAnimation, required this.scaleAnimation, required this.isLightMode});
            ...
            return AnimatedTile(
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                    color: isLightMode ? tileColors[tile.value] : tileColorsDark[tile.value],
              ...
              child: Column(
                ...
                children: [
                  ...
                  ButtonWidget(
                    ...
                    backgroundColor: isLightMode ? backgroundColor : backgroundColorDark,
                    textColor: isLightMode ? textColor : textColorDark,
